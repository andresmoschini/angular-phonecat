...
(function (window, document, undefined) {
    ...
    */
    ...
    LocationUrl.prototype = {
        /**
        * Allow to change URL transparentely without reinitialize all
        * @private
        */
        $$onlyChangeUrl: false,
        ...
        */
        ...
        /**
        * @ngdoc method
        * @name ng.$location#preventLocationChangeEvent
        * @methodOf ng.$location
        *
        * @description
        * Allow to change url transparentely without reinitialize all
